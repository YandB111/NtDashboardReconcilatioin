...
function filter_top() {
	...
	chartYear = document.getElementById("Chart_Year").value;4
...
// 			//display month and year after filter apply
...
function Table_top() {
	$.ajax({
		url: 'https://192.168.167.5:8743/Dashboard/dashboard/rev/api/getDayByDayRev?year=' + chartYear + '&month=' + chartMonth + '&currency=' + unit,
		dataType: 'json',
...
function Pie_top() {
	$.ajax({
		url: 'https://192.168.167.5:8743/Dashboard/dashboard/rev/api/getTotalRevByMonthly?year=' + chartYear + '&month=' + chartMonth,
		dataType: 'json',
...
function Table_offnet() {
	$.ajax({
		...
		url: 'https://192.168.167.5:8743/Dashboard/dashboard/rev/api/getCategoryByrev?year=' + chartYear + '&month=' + chartMonth + '&currency=' + unit,
		dataType: 'json',
		success: function (jsonData) {
			function unpack(data, key) {
...
function Pie_offnet() {
	$.ajax({
		url: 'https://192.168.167.5:8743/Dashboard/dashboard/rev/api/getCategoryByRevMonthly?year=' + chartYear + '&month=' + chartMonth,
		dataType: 'json',
		//var a = (jsonData.frodcaseClose);
		success: function (jsonData) {
			function unpack(data, key) {
...
function Table_incoming() {
	$.ajax({
		url: 'https://192.168.167.5:8743/Dashboard/dashboard/rev/api/DayByEventTypeRev?year=' + chartYear + '&month=' + chartMonth + '&currency=' + unit,
		dataType: 'json',
		success: function (jsonData) {
			function unpack(data, key) {
...
function incoming_pie() {
	$.ajax({
		url: 'https://192.168.167.5:8743/Dashboard/dashboard/rev/api/monthlyEventCatgRev?year=' + chartYear + '&month=' + chartMonth,
		dataType: 'json',
		success: function (jsonData) {
			function unpack(data, key) {
