...
function Table_1() {
    $.ajax({
        url: 'https://192.168.167.6:8743/Dashboard/dashboard/traffic/trafficRevenueDayByDay?year=' + chartYear + '&month=' + chartMonth + '&currency=' + unit,
        dataType: 'json',
...
function Table_2() {
    $.ajax({
        url: 'https://192.168.167.6:8743/Dashboard/dashboard/traffic/trafficRevenueGraph?year=' + chartYear + '&month=' + chartMonth + '&currency=' + unit,
        dataType: 'json',
        success: function (jsonData) {
            function unpack(data, key) {
...
function Table_3() {
    $.ajax({
        url: 'https://192.168.167.6:8743/Dashboard/dashboard/traffic/trafficRevenueCategory?year=' + chartYear + '&month=' + chartMonth + '&currency=' + unit,
        dataType: 'json',
        success: function (jsonData) {
            function unpack(data, key) {
