...
public class RoamingDayByRevModel {
	...
	private List<RoamingDayByRevList> list;
	public RoamingDayByRevModel() {
	
	}
	public RoamingDayByRevModel(String year, String month, String voiceMonthlySum, String smsMonthlySum,
			String gprsMonthlySUm, String toatlMonthlySum, String voiceRev_pie, String smsRev_pie, String gprsRev_Pie,
			 String averagepst, List<RoamingDayByRevList> list) {
			this.year = year;
		this.month = month;
	...
	public List<RoamingDayByRevList> getList() {
		return list;
	}
	public void setList(List<RoamingDayByRevList> list) {
		this.list = list;
	}
	@Override
	public String toString() {
		return "RoamingDayByRevModel [year=" + year + ", month=" + month + ", voiceMonthlySum=" + voiceMonthlySum
