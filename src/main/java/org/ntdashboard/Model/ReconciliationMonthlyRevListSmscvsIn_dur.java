...
public class ReconciliationMonthlyRevListSmscvsIn_dur {
	private String rtd_In_dur;
	  ...
	  public ReconciliationMonthlyRevListSmscvsIn_dur() {}
	  
	  public ReconciliationMonthlyRevListSmscvsIn_dur(String rtd_In_dur, String msc_In_dur, String dur_diff) {
