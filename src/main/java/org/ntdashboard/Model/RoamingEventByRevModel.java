...
public class RoamingEventByRevModel {
	...
	private List<RoamingEventByRevList> roamingEventByRevList;
	public RoamingEventByRevModel() {
		
	}
	public RoamingEventByRevModel(String year, String month, String onnetSum, String offnetsum, String nationalSUm,
			...
			List<RoamingEventByRevList> roamingEventByRevList) {
		...
		this.roamingEventByRevList = roamingEventByRevList;
	}
	...
	public List<RoamingEventByRevList> getRoamingEventByRevList() {
		return roamingEventByRevList;
	}
	public void setRoamingEventByRevList(List<RoamingEventByRevList> roamingEventByRevList) {
		this.roamingEventByRevList = roamingEventByRevList;
	}
	@Override
	public String toString() {
		return "RoamingEventByRevModel [year=" + year + ", month=" + month + ", onnetSum=" + onnetSum + ", offnetsum="
				...
				+ ", roamingEventByRevList=" + roamingEventByRevList + "]";
	}
