      ...
      <section class="revenue_section mt-3">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-title">Roaming Analysis - <span id='TopTable'></span>
                  <a href="#" class="btn  mt-0 mr-0 float-btn float-right text-dark bg-transparent"
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <table class="table table-bordered mb-0">
                        <thead class="thead-dark">
                          <tr>
                            <th scope="col">Total Revenue Roaming </th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                    ...
                    <div class="col-md-8">
                      <table class="table table-bordered table-hide mb-3">
                        <thead class="thead-dark">
                          <tr>
                            <th scope="col">Record Count Roaming</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                    ...
                    <div class="col-md-12">
                      <table class="table table-bordered mb-0">
                        <thead class="thead-dark">
                          <tr>
                            <th scope="col">Day On Day Growth(%)</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td id="bar_variance_1"></td>
                          </tr>
                          <!-- <tr>
      ...
      <section class="revenue_section mt-3">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-title">Revenue Roaming - <span id='centerTable'></span>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <table class="table table-bordered mb-0">
                        <thead class="thead-dark">
                          <tr>
                            <th scope="col">Revenue Bifurcation </th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                    ...
                    <div class="col-md-8">
                      <table class="table table-bordered mb-3">
                        <thead class="thead-dark">
                          <tr>
                            <th scope="col">Day-On-Day Revenue Bifurcation </th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
...
<script src="<%=contextPath%>/cs-execdashboard/portlets/ctva/execdashboardui/NEWDASH/js/jquery-3.5.1.min.js"></script>
  ...
  <script src="<%=contextPath%>/cs-execdashboard/portlets/ctva/execdashboardui/NEWDASH/js/script_roaming.js"></script>
