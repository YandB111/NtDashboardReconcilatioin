...
<body>
  <div class="fullPage">
    <div class="full-content">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-header card-title">Event Wise Revenue Analysis - <span id='TopTable'></span>
                  <!-- <header id='home_content' class="main-header fixed-top"> -->
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <table class="table table-bordered mb-0">
                        <thead class="thead-dark">
                          <tr>
                            <th scope="col">Event Wise Monthly Revenue Bifurcation</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                    ...
                    <div class="col-md-8">
                      <table class="table table-bordered mb-3">
                        <thead class="thead-dark">
                          <tr>
                            <th scope="col">Day-On-Day Event Wise Growth Analysis And Revenue Statistics</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td id="Daily_barchart">
                            </td>
                          </tr>
                          <!-- <tr>
                            <td id="Daily_line">
      ...
      <!--Revenue Bifurcation (Voice - Data - SMS - VAS)-->
      ...
      <section class="revenue_section mt-3 mb-3">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-title">Event Category Wise Revenue Analysis (Voice - Data - SMS - VAS) - <span
                    id='centerTable'></span>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12">
                      <div id="offnet" class="table-responsive">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <table class="table table-bordered mb-0">
                        <thead class="thead-dark">
                          <tr>
                            <th scope="col">Event Category Wise Monthly Revenue Bifurcation</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                    ...
                    <div class="col-md-8">
                      <table class="table table-bordered mb-3">
                        <thead class="thead-dark">
                          <tr>
                            <th scope="col">Day-On-Day Event Category Wise Growth Analysis And Revenue Statistics</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td id="Offnet_barchart">
                            </td>
                          </tr>
                          <!-- <tr>
                            <td id="Offnet_line">
      ...
      <!-- <section class="revenue_section mt-3">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-title">Revenue : Voice - Outgoing - Incoming & Others(SMS - GPRS) - <span
                    id='bottomTable'></span>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12">
                      <div id="incoming" class="table-responsive">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <table class="table table-bordered mb-0">
                        <thead class="thead-dark">
                          <tr>
                            <th scope="col">Revenue : Voice - Outgoing - Incoming & Others(SMS - GPRS)</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                    ...
                    <div class="col-md-8">
                      <table class="table table-bordered mb-5">
                        <thead class="thead-dark">
                          <tr>
                            <th scope="col">Day-On-Day Revenue : Voice - Outgoing - Incoming & Others(SMS - GPRS)</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td id="incoming_barchart">
                            </td>
                          </tr>
                          <tr>
                            <td id="Incoming_line">
...
<script src="<%=contextPath%>/cs-execdashboard/portlets/ctva/execdashboardui/NEWDASH/js/jquery-3.5.1.min.js"></script>
  ...
  <script src="<%=contextPath%>/cs-execdashboard/portlets/ctva/execdashboardui/NEWDASH/js/Revenue_script.js"></script>
  ...
  <script src="<%=contextPath%>/cs-execdashboard/portlets/ctva/execdashboardui/NEWDASH/js/daterangepicker.js"></script>  <script>
    ...
    // document.getElementById('bottomTable').innerHTML = d + ' ' + year + ' (In ' + unit + ')';
  </script>
</body>
</html>
