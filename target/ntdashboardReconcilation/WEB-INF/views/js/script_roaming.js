    ...
    var chartYear = year_curr;       
     function filter_top() {
       ...
       document.getElementById('centerTable').innerHTML = chartMonth + ' ' + chartYear + ' (In ' + unit + ')';
            ...
            table2.innerHTML = '';
            bar_2.innerHTML = '';
            bar_variance_1.innerHTML='';
            bar_variance_2.innerHTML = '';
            pie_1.innerHTML = '';
            pie_2.innerHTML = '';
            Table_1();
            Table_2()
          ...
          function Reload() {
        console.log("function reached here and called once ");
     ...
     url = 'https://10.26.194.52:8743/Dashboard/dashboard/roaming/';
    function Table_1() {
    $.ajax({
        url: url+'RoamingDayByDayRev?year='+ chartYear+'&month='+ chartMonth+'&currency='+unit,  
      dataType: 'json',
...
function Table_2() {
    $.ajax({
        url: url+'RoamingEventByRev?year='+ chartYear+'&month='+ chartMonth+'&currency='+unit,
        dataType: 'json',
        success: function (jsonData) {
            function unpack(data, key) {
